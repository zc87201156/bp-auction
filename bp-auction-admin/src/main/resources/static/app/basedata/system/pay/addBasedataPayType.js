Ext.define('JDD.basedata.system.pay.addBasedataPayType', {
    extend: 'Ext.window.Window',
    alias: 'addBasedataPayType',
    title: '新增支付方式',
    modal: true,
    layout: {
        type: 'vbox',
    ...
    buttons: [{
        ...
        handler: function () {
            ...
            callapi("/basedata/private/basedataPayTypeController/saveBasedataPayType.do", form.getValues(),
                function (result) {
                    if (result.success) {
                        Ext.MessageBox.show({
                            title: "提示",
