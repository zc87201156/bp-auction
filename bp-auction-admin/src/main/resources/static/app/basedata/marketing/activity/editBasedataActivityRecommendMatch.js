Ext.define('JDD.basedata.marketing.activity.editBasedataActivityRecommendMatch', {
    extend: 'Ext.window.Window',
    alias: 'editBasedataActivityRecommendMatch',
    title: '编辑活动赛事推荐管理',
    modal: true,
    layout: {
        type: 'vbox',
    ...
    initComponent: function () {
        ...
        me.add({
            ...
            items: [{
                ...
                colspan: 2,
                items: [
                    {boxLabel: '竞彩足球', name: 'lotteryId', inputValue: '90'},
    ...
    buttons: [{
        ...
        handler: function () {
            ...
            callapi("/basedata/private/basedataActivityRecommendMatchController/updateBasedataActivityRecommendMatch.do", form.getValues(),
                function (result) {
                    if (result.success) {
                        Ext.MessageBox.show({
                            title: "提示",
