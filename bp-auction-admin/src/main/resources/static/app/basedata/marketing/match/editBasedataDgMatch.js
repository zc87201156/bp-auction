Ext.define('JDD.basedata.marketing.match.editBasedataDgMatch', {
    extend: 'Ext.window.Window',
    alias: 'editBasedataDgMatch',
    title: '编辑单关配活动',
    modal: true,
    layout: {
        type: 'vbox',
    ...
    initComponent: function () {
        ...
        var lotteries = [];
        var obj = [[1, '让球胜平负'], [2, '总进球'], [3, '猜比分'], [4, '半全场'], [6, '胜平负']];
        for (var row in obj) {
            var lottery = obj[row];
            lotteries.push([lottery[0], lottery[1]]);
        }
        me.add({
            xtype: 'dataform',
            baseCls: 'x-plain',
    ...
    buttons: [{
        ...
        handler: function () {
            ...
            callapi("/basedata/private/basedataDgMatchController/updateBasedataDgMatch.do", datas,
                function (result) {
                    if (result.success) {
                        Ext.MessageBox.show({
                            title: "提示",
