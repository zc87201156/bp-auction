Ext.define('JDD.basedata.lottery.info.editlotteryInfo', {
    extend: 'Ext.window.Window',
    alias: 'editlotteryInfo',
    title: '编辑彩种',
    modal: true,
    width: 400,
    layout: {
    ...
    initComponent: function () {
        ...
        var lotteries = [];
        var obj = callapiAsync('basedata/private/basedataLotteryTagController/listAllBasedataLotteryTag.do', null);
        for (var row in obj) {
            var lottery = obj[row];
            lotteries.push([lottery.code, lottery.name]);
        }
        me.add({
            xtype: 'dataform',
            baseCls: 'x-plain',
    ...
    buttons: [{
        ...
        handler: function () {
            ...
            callapi("/basedata/private/basedataLotteryController/updateBasedataLottery.do", datas,
                function (result) {
                    if (result.success) {
                        Ext.MessageBox.show({
                            title: "提示",
