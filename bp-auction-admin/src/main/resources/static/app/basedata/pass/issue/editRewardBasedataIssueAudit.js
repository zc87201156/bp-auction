Ext.define('JDD.basedata.pass.issue.editRewardBasedataIssueAudit', {
  extend: 'Ext.window.Window',
  alias: 'editRewardBasedataIssueAudit',
  modal: true,
  title: '开奖信息录入',
  width: 1000,
  height: 600,
  ...
  buttons: [{
    ...
    handler: function () {
      ...
      callapi("/basedata/private/basedataIssuePassController/addBasedataIssuePassRewardAudit.do", datas,
          function (result) {
            if (result.success) {
              Ext.Msg.show({
                title: "提示",
