Ext.define('JDD.basedata.pass.issue.editBasedataIssueAudit', {
    extend: 'Ext.window.Window',
    alias: 'editBasedataIssueAudit',
    title: '号码录入',
    modal: true,
    Say: function (msg) {
        this.title = msg;
    ...
    buttons: [{
        ...
        handler: function () {
            ...
            callapi("/basedata/private/basedataIssuePassController/addBasedataIssueWinNumberAudit.do", form.getValues(),
                function (result) {
                    if (result.success) {
                        Ext.MessageBox.show({
                            title: "提示",
