Ext.define('JDD.basedata.pass.issue.basedataPassIssueMain', {
    extend: 'Ext.panel.Panel',
    title: '彩种页',
    xtype: 'basedataPassIssueMain',
    closable: true,
    layout: {
        type: 'vbox',
        align: 'stretch'
            ...
            columns: [
                {
                    ...
                    links: [{
                        ...
                        handler: function (grid, rowIndex, colIndex, record) {
                            var win = Ext.create("JDD.basedata.pass.issue.editBasedataIssue", {
                                store: store
                            });
                            win.Say("号码录入【" + record.data.lotteryName + " 第" + record.data.issueName + "期】");
                            ...
                            s.regex = regexs;
                            win.down('dataform').down("[name='auditStatus']").setValue(0);
                    ...
                    },
                        {
                            ...
                            handler: function (grid, rowIndex, colIndex, record) {
                                ...
                                var win = Ext.create("JDD.basedata.pass.issue.editRewardBasedataIssue", {
                                ...
                                win.Say("开奖信息录入【" + record.data.lotteryName + " 第" + record.data.issueName + "期】");
                                win.down('dataform').setValues(record.data);
                                win.down('dataform').down("[name='auditStatus']").setValue(0);
                                win.show();
                            }
