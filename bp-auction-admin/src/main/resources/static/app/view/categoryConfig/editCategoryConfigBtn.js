Ext.define("WF.view.categoryConfig.editCategoryConfigBtn", {
    extend: "Ext.Button",
    alias: "editCategoryConfigBtn",
    text: '编辑',
    ...
    listeners: {
        click: function () {
            ...
            var win = Ext.create("WF.view.categoryConfig.editCategoryConfig", {doRefresh: grid.store});
